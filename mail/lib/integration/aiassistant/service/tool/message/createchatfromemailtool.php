...
class CreateChatFromEmailTool extends ToolContract
{
	public const ACTION_NAME = 'create_chat_from_email';
	...
	{
		return
			"Creates a group chat from a mail message or returns existing chat if already created. "
			. "Links the chat to the message. "
	...
	public function getInputSchema(): array
	{
		return [
			...
			'properties' => [
				'messageId' => [
					'type' => 'integer',
					'description' => 'Identifier of the mail message to create chat from.',
					'minimum' => 1,
				],
			],
			'required' => ['messageId'],
