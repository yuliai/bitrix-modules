...
class Employee extends Base
{
	...
	{
		return [
			PermissionDictionary::MAIL_ACCESS_RIGHTS_EDIT => PermissionDictionaryAlias::VALUE_NO,
			PermissionDictionary::MAIL_MAILBOX_LIST_ITEM_VIEW => PermissionVariablesDictionary::VARIABLE_NONE,
