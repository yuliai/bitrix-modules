...
final class UnhideCatalogItemCommandHandler
{
	...
	public function __invoke(UnhideCatalogItemCommand $command): void
	{
		...
		$this->hiddenRepository->delete($command->userId, $command->catalogItemId);
	}
}
