...
class CCrmDocumentCompany extends CCrmDocument implements IBPWorkflowDocument
{
	...
	public static function getEntityFields($entityType)
	{
		...
		$regAddressLabels = Bitrix\Crm\EntityAddress::getShortLabels(Bitrix\Crm\EntityAddressType::Registered);
		...
		$arResult = static::getVirtualFields() + array(
			...
			'LOGO' => array(
				'Name' => static::getEntityFieldCaption($entityTypeId, 'LOGO'),
				'Type' => 'file',
				'Filterable' => false,
				'Editable' => true,
				'Required' => false,
			...
			'COMPANY_TYPE' => array(
				'Name' => static::getEntityFieldCaption($entityTypeId, 'COMPANY_TYPE'),
				'Type' => 'select',
			...
			'INDUSTRY' => array(
				'Name' => static::getEntityFieldCaption($entityTypeId, 'INDUSTRY'),
				'Type' => 'select',
			...
			'EMPLOYEES' => array(
				'Name' => static::getEntityFieldCaption($entityTypeId, 'EMPLOYEES'),
				'Type' => 'select',
			...
			'REVENUE' => array(
				'Name' => static::getEntityFieldCaption($entityTypeId, 'REVENUE'),
				'Type' => 'string',
				'Filterable' => true,
				'Editable' => true,
				'Required' => false,
		...
		$arResult += array(
			...
			'ADDRESS' => array(
				'Name' => static::getEntityFieldCaption($entityTypeId, 'ADDRESS'),
				'Type' => 'text',
				'Filterable' => true,
				'Editable' => true,
				'Required' => false,
			...
			'ADDRESS_LEGAL' => array(
				'Name' => static::getEntityFieldCaption($entityTypeId, 'ADDRESS_LEGAL'),
				'Type' => 'text',
				'Filterable' => true,
				'Editable' => true,
				'Required' => false,
			...
			'BANKING_DETAILS' => array(
				'Name' => static::getEntityFieldCaption($entityTypeId, 'BANKING_DETAILS'),
				'Type' => 'text',
				'Filterable' => true,
				'Editable' => true,
				'Required' => false,
	...
	public static function CreateDocument($parentDocumentId, $arFields)
	{
		...
		$starter = new CrmStarter(new DocumentDto(\CCrmOwnerType::Company, (int)$ID));
		$result = $starter
	...
	public static function UpdateDocument($documentId, $arFields, $modifiedById = null)
	{
		...
		$starter = new CrmStarter(new DocumentDto(\CCrmOwnerType::Company, (int)$arDocumentID['ID']));
		$result = $starter
			->setContextModuleId('bizproc')
