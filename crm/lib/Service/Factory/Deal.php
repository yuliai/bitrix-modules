...
final class Deal extends Factory
{
	...
	protected function getFieldsSettings(): array
	{
		...
		{
			$info[Item::FIELD_NAME_REPEAT_SALE_SEGMENT_ID] = [
				'TYPE' => Field::TYPE_CRM_REPEAT_SALE_SEGMENT_TITLE,
				'ATTRIBUTES' => [\CCrmFieldInfoAttr::ReadOnly, \CCrmFieldInfoAttr::Multiple],
			];
		}
