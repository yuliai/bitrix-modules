...
//		return $this->type->getIsCrmTrackingEnabled();
	...
	public function getUpdateOperation(Item $item, Context $context = null): Operation\Update
	{
		...
		return $operation
			...
			->addAction(
				OPERATION::ACTION_AFTER_SAVE,
				new Operation\Action\UpdateRecurringTemplate(),
			)
			->addAction(
				OPERATION::ACTION_AFTER_SAVE,
	...
	public function getDeleteOperation(Item $item, Context $context = null): Operation\Delete
	{
		...
		return $operation
			...
			->addAction(
				Operation::ACTION_AFTER_SAVE,
				new Operation\Action\DeleteRecurringDynamicSchedule(),
			)
		;
	}
	...
	{
		return new Statistics\OperationFacade\Dynamic($this);
	}
}
