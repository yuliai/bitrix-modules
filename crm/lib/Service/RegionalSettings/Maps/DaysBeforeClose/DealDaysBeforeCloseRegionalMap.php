...
final class DealDaysBeforeCloseRegionalMap extends BaseRegionalSettingMap
{
	public function getMap(): array
	{
		$regionPrefix = RegionalSettings::DIMENSION_REGION . RegionalSettings::VALUE_SEPARATOR;
		$culturePrefix = RegionalSettings::DIMENSION_CULTURE . RegionalSettings::VALUE_SEPARATOR;
