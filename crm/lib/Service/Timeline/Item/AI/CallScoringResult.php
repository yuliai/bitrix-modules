...
final class CallScoringResult extends Base
{
	...
	protected function getJobResult(): ?Result
	{
		...
		return JobRepository::getInstance()->getCallScoringResult($activityId, $this->getJobId());
	}
	...
	private function getScoringResult(): ?array
	{
		...
		return AiQualityAssessmentController::getInstance()
			->getByActivityIdAndJobId($activityId, $this->getJobId())
		;
	}
}
