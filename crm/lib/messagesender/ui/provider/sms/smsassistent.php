...
final class SmsAssistent extends Provider
{
	...
	public function createConnectionsSliderSections(array $channels): array
	{
		...
		foreach ($editorViewChannels as $editorViewChannel)
		{
			...
			$iconPath = $isConnected
				? '/bitrix/components/bitrix/crm.messagesender.connections/images/sms-assistent-connected.svg'
				: '/bitrix/components/bitrix/crm.messagesender.connections/images/sms-assistent-not-connected.svg';
	...
	{
		$usedChannels = array_filter($channels, static fn(Channel $c) => Taxonomy::isSmsAssistent($c));
