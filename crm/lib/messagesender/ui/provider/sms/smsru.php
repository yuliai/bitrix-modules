...
final class SmsRu extends Provider
{
	...
	public function createConnectionsSliderSections(array $channels): array
	{
		...
		foreach ($editorViewChannels as $editorViewChannel)
		{
			...
			$iconPath = $isConnected
				? '/bitrix/components/bitrix/crm.messagesender.connections/images/sms-smsru-connected.svg'
				: '/bitrix/components/bitrix/crm.messagesender.connections/images/sms-smsru-not-connected.svg';
	...
	{
		$usedChannels = array_filter($channels, static fn(Channel $c) => Taxonomy::isSmsRu($c));
