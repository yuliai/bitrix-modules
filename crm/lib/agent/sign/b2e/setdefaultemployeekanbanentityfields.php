...
final class SetDefaultEmployeeKanbanEntityFields extends AgentBase
{
	...
	public static function doRun(): bool
	{
		...
		$defaultCategoryId = $typeService->getCategoryByCode($typeService::SIGN_B2E_EMPLOYEE_ITEM_CATEGORY_CODE)['ID'];
