...
class Preset
{
	...
	public static function getList(): array
	{
		...
		if (ModuleManager::isModuleInstalled('booking'))
		{
			...
			$list[] = self::getBookingPresetItem(BaseScenario::SCENARIO_BOOKING_AUTO_SELECTION_SERVICES);
			$list[] = self::getBookingPresetItem(BaseScenario::SCENARIO_BOOKING_ANY_RESOURCE_SERVICES);
			$list[] = self::getBookingPresetItem(BaseScenario::SCENARIO_BOOKING_MANUAL_SETTINGS_SERVICES);
		}
	...
	private static function getBookingPresetItem(string $templateId): array
	{
		$template2Name = [
			...
			BaseScenario::SCENARIO_BOOKING_AUTO_SELECTION_SERVICES => Loc::getMessage('CRM_WEBFORM_PRESET_ITEM_BOOKING_AUTO_SELECTION_SERVICES_NAME'),
			BaseScenario::SCENARIO_BOOKING_ANY_RESOURCE_SERVICES => Loc::getMessage('CRM_WEBFORM_PRESET_ITEM_BOOKING_ANY_RESOURCE_SERVICES_NAME'),
			BaseScenario::SCENARIO_BOOKING_MANUAL_SETTINGS_SERVICES => Loc::getMessage('CRM_WEBFORM_PRESET_ITEM_BOOKING_MANUAL_SETTING_SERVICES_NAME'),
		];
