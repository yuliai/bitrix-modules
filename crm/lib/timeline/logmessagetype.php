...
final class LogMessageType
{
	...
	public const AI_START_RECORD_TRANSCRIPT = 17;
	public const AI_START_RECORD_TRANSCRIPT_SUMMARY = 18;
	public const AI_START_FILLING_ENTITY_FIELDS = 19;
	public const AI_FINISH_FILLING_ENTITY_FIELDS = 20;
	public const AI_LAUNCH_ERROR = 21;
	public const AI_AUTOMATION_LAUNCH_ERROR = 22;
