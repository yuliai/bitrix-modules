		...
		return [
			...
			'FIELDS' => [
				...
				'SRC_ENTITY_DATASET_NAME' => [
					'IS_METRIC' => 'N', // 'Y'
					'FIELD_NAME' => 'CASE WHEN DTS.ID IS NOT NULL THEN CONCAT(\'crm_dynamic_items_\', DTS.ENTITY_TYPE_ID) ELSE ' . static::getNameByField('ER.SRC_ENTITY_TYPE_ID') . ' END',
					'FIELD_TYPE' => 'string',
					'TABLE_ALIAS' => 'DTS',
				...
				'DST_ENTITY_DATASET_NAME' => [
					'IS_METRIC' => 'N', // 'Y'
					'FIELD_NAME' => 'CASE WHEN DTD.ID IS NOT NULL THEN CONCAT(\'crm_dynamic_items_\', DTD.ENTITY_TYPE_ID) ELSE ' . static::getNameByField('ER.DST_ENTITY_TYPE_ID') . ' END',
					'FIELD_TYPE' => 'string',
					'TABLE_ALIAS' => 'DTD',
