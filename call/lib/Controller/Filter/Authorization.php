...
class Authorization extends Base
{
	...
	public function onBeforeAction(Event $event)
	{
		...
		{
			if ($USER->GetParam('EXTERNAL_AUTH_ID') === \Bitrix\Call\Rest\Auth::AUTH_TYPE)
			{
		...
		if ($userData && $userData['EXTERNAL_AUTH_ID'] === \Bitrix\Call\Rest\Auth::AUTH_TYPE)
		{
			\Bitrix\Call\Rest\Auth::authorizeById($userData['ID']);
			\CUser::SetLastActivityDate($USER->GetID(), true);
