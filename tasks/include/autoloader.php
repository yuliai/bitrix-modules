...
$classes = [
	...
	'\Bitrix\Tasks\Exception' => 'lib/exception.php',
	...
	'TasksException' => 'tools/tasksexception.php',
	'CTasksPerHitOption' => 'tools/ctasksperhitoption.php',
];

CModule::AddAutoloadClasses('tasks', $classes);
