...
{
#region autogenerated services for module tasks
	...
	override(
		...
		map([
			...
			'tasks.flow.copilot.collected.data.service' => \Bitrix\Tasks\Flow\Integration\AI\Control\CollectedDataService::class,
			'tasks.flow.copilot.advice.service' => \Bitrix\Tasks\Flow\Integration\AI\Control\AdviceService::class,
