...
class TaskFilterBuilder
{
				...
				case "STATUS":
					$field = new ExpressionField(
						...
						["DEADLINE",
							...
							"RESPONSIBLE_ID",
							"CREATED_BY",
							TaskQueryBuilder::ALIAS_TASK_VIEW . ".USER_ID"]
					);
	...
	private function translateUfFilter(string $field, string $operation, $fieldValues, bool $needEscape = true): array
	{
		...
		foreach ($fieldValues as $value)
		{
			...
			if (in_array($operation, [self::OPERATION_LESS,
				self::OPERATION_LESS_EQ,
				self::OPERATION_GREAT,
				self::OPERATION_GREAT_EQ], true))
			{
