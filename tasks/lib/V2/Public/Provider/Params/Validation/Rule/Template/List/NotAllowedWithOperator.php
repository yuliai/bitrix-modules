...
class NotAllowedWithOperator implements ValidatorInterface
{
	public function __construct(private readonly array $notAllowedOperators)
	{
	}
	...
	public function validate(mixed $value): ValidationResult
	{
		...
		if (in_array($value->operator, $this->notAllowedOperators))
		{
			$result->addError(
				new ValidationError(
