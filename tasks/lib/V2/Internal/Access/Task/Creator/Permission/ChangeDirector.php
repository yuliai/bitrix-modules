...
namespace Bitrix\Tasks\V2\Internal\Access\Task\Creator\Permission;
...
class ChangeDirector implements AttributeAccessInterface
{
	...
	): bool
	{
		...
		return $accessController->check(ActionDictionary::ACTION_TASK_CHANGE_DIRECTOR, $before, $after);
	}
}
