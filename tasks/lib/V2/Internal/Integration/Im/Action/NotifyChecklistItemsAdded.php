...
class NotifyChecklistItemsAdded extends AbstractNotify
{
	...
	public function getMessageCode(): string
	{
		return match ($this->triggeredBy?->getGender()) {
			Entity\User\Gender::Male   => 'TASKS_IM_CHECKLIST_ITEMS_ADDED_M',
			Entity\User\Gender::Female => 'TASKS_IM_CHECKLIST_ITEMS_ADDED_F',
			default                    => 'TASKS_IM_CHECKLIST_ITEMS_ADDED_M',
		};
	}
