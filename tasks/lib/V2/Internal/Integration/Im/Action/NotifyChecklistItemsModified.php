...
class NotifyChecklistItemsModified extends AbstractNotify
{
	...
	public function getMessageCode(): string
	{
		return match ($this->triggeredBy?->getGender()) {
			Entity\User\Gender::Male   => 'TASKS_IM_CHECKLIST_ITEMS_MODIFIED_M',
			Entity\User\Gender::Female => 'TASKS_IM_CHECKLIST_ITEMS_MODIFIED_F',
			default                    => 'TASKS_IM_CHECKLIST_ITEMS_MODIFIED_M',
		};
	}
