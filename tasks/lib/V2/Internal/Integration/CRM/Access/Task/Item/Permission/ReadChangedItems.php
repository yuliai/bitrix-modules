...
class ReadChangedItems implements AttributeAccessInterface
{
	...
	public function check(EntityInterface $entity, Context $context, array $parameters = []): bool
	{
		...
		return Container::getInstance()->getCrmAccessService()->canChangeCrmItems(
			ids: (array)$entity->crmItemIds,
