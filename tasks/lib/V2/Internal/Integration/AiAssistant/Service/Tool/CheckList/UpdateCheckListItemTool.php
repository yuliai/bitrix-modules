...
class UpdateCheckListItemTool extends BaseTool
{
	public const ACTION_NAME = 'update_check_list_item';
	...
	{
		return 'Updates the name or order of an existing checklist item.';
	}

	protected function execute(int $userId, ...$args): string
	{
		$dto = UpdateCheckListItemDto::fromArray($args);
