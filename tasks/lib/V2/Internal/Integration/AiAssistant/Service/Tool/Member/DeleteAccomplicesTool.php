...
class DeleteAccomplicesTool extends BaseTool
{
	public const ACTION_NAME = 'delete_accomplices';
	...
	{
		$dto = DeleteAccomplicesDto::fromArray($args);

		try
		{
			$this->validate($dto);

			$this->memberService->deleteAccomplices($dto, $userId);
		}
		...
		return "Accomplices for task successfully deleted.";
	}
}
