...
use Bitrix\Tasks\V2\Internal\EventHandler\Task\OnPlanChanged;

#[ListenBy(
	OnPlanChanged\NotifyChat::class,
)]
class OnPlanChangedEvent
{
	public function __construct(
		public readonly Entity\Task $task,
		public readonly Entity\Task $taskBefore,
