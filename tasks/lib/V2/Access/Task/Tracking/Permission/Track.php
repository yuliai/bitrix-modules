...
namespace Bitrix\Tasks\V2\Access\Task\Tracking\Permission;
...
class Track implements AttributeAccessInterface
{
	...
	public function check(Entity\EntityInterface $entity, Context $context): bool
	{
		...
		return $accessController->checkByItemId(ActionDictionary::ACTION_TASK_TIME_TRACKING, $model?->getId());
	}
}