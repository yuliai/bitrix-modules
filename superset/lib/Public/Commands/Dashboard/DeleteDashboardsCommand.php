...
final class DeleteDashboardsCommand extends AbstractServerCommand
{
	public function __construct(
		public readonly ServerReferenceDto $server,
		public readonly array $dashboardIds,
		public readonly bool $deleteRelatedEntities = false,
	)
	{
	}
	...
	{
		return (new DashboardService($this->resolveServer($this->server)))->delete(
			$this->dashboardIds,
