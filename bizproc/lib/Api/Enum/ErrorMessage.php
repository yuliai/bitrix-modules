...
enum ErrorMessage: string
{
	...
	case SCRIPT_START_NOT_SUPPORTED = 'SCRIPT_START_NOT_SUPPORTED';
	...
	case OVER_LIMITED = 'OVER_LIMITED';
	case CONSTANTS_NOT_TUNED = 'CONSTANTS_NOT_TUNED';
	case NO_AVAILABLE_AI_AGENTS_TO_DELETE = 'NO_AVAILABLE_AI_AGENTS_TO_DELETE';
	case AI_AGENT_DELETE_ERROR = 'AI_AGENT_DELETE_ERROR';
	case DELETE_TEMPLATE_UNAUTHORIZED = 'DELETE_UNAUTHORIZED';
	...
	public function get(array $replace = []): string
	{
		return match ($this) {
			...
			self::DELETE_TEMPLATE_UNAUTHORIZED => Loc::getMessage('BIZPROC_API_ENUM_ERRORS_DELETE_TEMPLATE_UNAUTHORIZED'),
			...
			self::SCRIPT_START_NOT_SUPPORTED => Loc::getMessage('BIZPROC_API_ENUM_ERRORS_SCRIPT_START_NOT_SUPPORTED'),
			self::INVALID_USER_ID => Loc::getMessage('BIZPROC_API_ENUM_ERRORS_INVALID_USER_ID'),
			self::NO_AVAILABLE_AI_AGENTS_TO_DELETE => Loc::getMessage('BIZPROC_API_ENUM_ERRORS_NO_AVAILABLE_AI_AGENTS_TO_DELETE'),
			...
			self::CONSTANTS_NOT_TUNED => Loc::getMessage('BIZPROC_API_ENUM_ERRORS_CONSTANTS_NOT_TUNED'),
