...
\Sprint\Migration\Locale::loadLocale(
    ...
    [
        ...
        "BUILDER_HlblockElementsExport_Filter"                   => "Выберите элементы",
        "BUILDER_HlblockElementsExport_SelectSomeId"             => "Указать ID элементов",
        "BUILDER_HlblockElementsExport_SelectSomeXmlId"          => "Указать XML_ID элементов",
        "BUILDER_HlblockElementsExport_FilterListId"             => "Укажите ID элементов через пробел",
        "BUILDER_HlblockElementsExport_UpdateMethod"             => "Настройка переноса",
        "BUILDER_HlblockElementsExport_NotUpdate"                => "Простое добавление элементов",
        "BUILDER_HlblockElementsExport_SaveElementWithEqualKeys" => "Добавить или обновить элементы с совпадающими полями",
        "BUILDER_HlblockElementsExport_SaveElementByXmlId"       => "Добавить или обновить элементы с совпадающими XML_ID",
        "BUILDER_HlblockElementsExport_EqualKeys"                => "Выберите поля для сравнения",
    ]
);
\Sprint\Migration\Locale::loadLocale(
    "ru",
...
\Sprint\Migration\Locale::loadLocale(
    ...
    [
        ...
        "ERR_ORDER_PROPERTY_VARIANT_NOT_ADDED"   => "Вариант перечисления с названием \"#NAME#\" не добавлен (#MESSAGE#)",
        "ERR_ORDER_PROPERTY_VARIANT_NOT_UPDATED" => "Вариант перечисления с названием \"#NAME#\" не обновлен (#MESSAGE#)",
        "ERR_ORDER_PROPERTY_VARIANT_NOT_DELETED" => "Вариант перечисления с названием \"#NAME#\" не удален (#MESSAGE#)",
...
\Sprint\Migration\Locale::loadLocale(
    ...
    [
        ...
        "ORDER_PROPERTY_VARIANT_ADDED"   => "Вариант перечисления с названием \"#NAME#\" добавлен",
        "ORDER_PROPERTY_VARIANT_UPDATED" => "Вариант перечисления с названием \"#NAME#\" обновлен",
        "ORDER_PROPERTY_VARIANT_DELETED" => "Вариант перечисления с названием \"#NAME#\" удален",
...
\Sprint\Migration\Locale::loadLocale(
    "ru",
    [
        "ENTITY_TITLE_HLBLOCK"        => "Highload-блок / NAME / TITLE",
