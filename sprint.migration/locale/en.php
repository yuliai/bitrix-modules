...
\Sprint\Migration\Locale::loadLocale(
    ...
    [
        ...
        "BUILDER_HlblockElementsExport_Filter"                   => "Select elements",
        "BUILDER_HlblockElementsExport_SelectSomeId"             => "Enter elements ID",
        "BUILDER_HlblockElementsExport_SelectSomeXmlId"          => "Enter elements XML_ID",
        "BUILDER_HlblockElementsExport_FilterListId"             => "Enter elements ID by space",
        "BUILDER_HlblockElementsExport_UpdateMethod"             => "Export settings",
        "BUILDER_HlblockElementsExport_NotUpdate"                => "Only add elements",
        "BUILDER_HlblockElementsExport_SaveElementWithEqualKeys" => "Add or update existing elements with equal fields",
        "BUILDER_HlblockElementsExport_SaveElementByXmlId"       => "Add or update existing elements by XML_ID",
        "BUILDER_HlblockElementsExport_EqualKeys"                => "Select equal fields",
    ]
);
\Sprint\Migration\Locale::loadLocale(
    "en",
...
\Sprint\Migration\Locale::loadLocale(
    ...
    [
        ...
        "ERR_ORDER_PROPERTY_VARIANT_NOT_ADDED"   => "Enum option with name \"#NAME#\" not created (#MESSAGE#)",
        "ERR_ORDER_PROPERTY_VARIANT_NOT_UPDATED" => "Enum option with name \"#NAME#\" not updated (#MESSAGE#)",
        "ERR_ORDER_PROPERTY_VARIANT_NOT_DELETED" => "Enum option with name \"#NAME#\" not deleted (#MESSAGE#)",
...
\Sprint\Migration\Locale::loadLocale(
    ...
    [
        ...
        "ORDER_PROPERTY_VARIANT_ADDED"   => "Enum option with name \"#NAME#\" created",
        "ORDER_PROPERTY_VARIANT_UPDATED" => "Enum option with name \"#NAME#\" updated",
        "ORDER_PROPERTY_VARIANT_DELETED" => "Enum option with name \"#NAME#\" deleted",
...
\Sprint\Migration\Locale::loadLocale(
    "en",
    [
        "ENTITY_TITLE_HLBLOCK"        => "Highload block / NAME / TITLE",
