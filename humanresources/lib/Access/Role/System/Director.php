...
class Director extends Base
{
	public function getPermissions(): array
	{
		return [
			...
			PermissionDictionary::HUMAN_RESOURCES_DEPARTMENT_SETTINGS_EDIT => PermissionVariablesDictionary::VARIABLE_SELF_DEPARTMENTS_SUB_DEPARTMENTS,
			PermissionDictionary::HUMAN_RESOURCES_DEPARTMENT_CHAT_EDIT => PermissionVariablesDictionary::VARIABLE_SELF_DEPARTMENTS_SUB_DEPARTMENTS,
			PermissionDictionary::HUMAN_RESOURCES_DEPARTMENT_CHANNEL_EDIT => PermissionVariablesDictionary::VARIABLE_SELF_DEPARTMENTS_SUB_DEPARTMENTS,
			PermissionDictionary::HUMAN_RESOURCES_DEPARTMENT_COLLAB_EDIT => PermissionVariablesDictionary::VARIABLE_SELF_DEPARTMENTS_SUB_DEPARTMENTS,
