...
class UsageStatDatasetProvider extends BaseProvider
{
	public const ENTITY_ID = 'biconnector-usage-stat-dataset';
	...
	public function fillDialog(Dialog $dialog): void
	{
		$dialog->addTab(new Tab([
			'id' => self::TAB_ID,
			'title' => Loc::getMessage('BIC_USAGE_STAT_ENTITY_SELECTOR_DATASET_TAB'),
			'stub' => true,
		]));

		$entries = $this->usageStatProvider->searchUsedDatasets(null, null, self::ELEMENTS_LIMIT);
	...
	public function doSearch(SearchQuery $searchQuery, Dialog $dialog): void
	{
		...
		$entries = $this->usageStatProvider->searchUsedDatasets(
	...
	public function getItems(array $ids): array
	{
		...
		$entries = $this->usageStatProvider->searchUsedDatasets(null, array_map('strval', $ids));
