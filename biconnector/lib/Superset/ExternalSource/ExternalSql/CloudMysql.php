...
final class CloudMysql implements ExternalSource\Source
{
	...
	{
		return Loc::getMessage('BICONNECTOR_EXTERNAL_SOURCE_CLOUD_MYSQL_TITLE');
	}

	public function getDescription(): string
	{
		return Loc::getMessage('BICONNECTOR_EXTERNAL_SOURCE_CLOUD_MYSQL_DESCRIPTION');
	}
