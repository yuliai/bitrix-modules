			...
			foreach ($RAT_ARRAY as $RAT_TYPE => $COMPONENT)
			{
				...
				foreach ($COMPONENT as $COMPONENT_NAME => $COMPONENT_VALUE)
				{
					...
					$arFields_i = [
						...
						"CLASS" => $arRatingConfigs[$MODULE_ID][$MODULE_ID . "_" . $RAT_TYPE . "_" . $COMPONENT_NAME]["CLASS"] ?? null,
						"CALC_METHOD" => $arRatingConfigs[$MODULE_ID][$MODULE_ID . "_" . $RAT_TYPE . "_" . $COMPONENT_NAME]["CALC_METHOD"] ?? null,
						"EXCEPTION_METHOD" => $arRatingConfigs[$MODULE_ID][$MODULE_ID . "_" . $RAT_TYPE . "_" . $COMPONENT_NAME]["EXCEPTION_METHOD"] ?? null,
						"REFRESH_INTERVAL" => $arRatingConfigs[$MODULE_ID][$MODULE_ID . "_" . $RAT_TYPE . "_" . $COMPONENT_NAME]["REFRESH_TIME"] ?? null,
						"~LAST_MODIFIED" => $DB->GetNowFunction(),
