...
class Onboardingbot extends Base
{
	...
	const BOT_CODE = 'onboardingbot';
	const BOT_COLOR = 'AZURE';
	const BOT_GENDER = 'F';

	public static function register(array $params = []): bool|int|string
	{
		...
		$botId = \Bitrix\Im\Bot::register([
			...
			'PROPERTIES' => [
				'NAME' => Loc::getMessage('IMBOT_ONBOARDINGBOT_BOT_NAME'),
				'WORK_POSITION' => Loc::getMessage('IMBOT_ONBOARDINGBOT_WORK_POSITION'),
				'COLOR' => self::BOT_COLOR,
				'PERSONAL_GENDER' => self::BOT_GENDER,
	...
	public static function onCommandAdd($messageId, $messageFields)
	{
		...
		$sender = new \Bitrix\ImBot\Sender\Onboardingbot();
