...
class Csmbot extends Base
{

	const MODULE_ID = 'imbot';
	const BOT_CODE = 'csmbot';
	...
	public static function register(array $params = []): bool|int|string
	{
		...
		$botId = \Bitrix\Im\Bot::register([
			...
			'PROPERTIES' => [
				'NAME' => Loc::getMessage('IMBOT_CSMBOT_BOT_NAME'),
				'WORK_POSITION' => Loc::getMessage('IMBOT_CSMBOT_WORK_POSITION'),
	...
	public static function onCommandAdd($messageId, $messageFields)
	{
		...
		$sender = new \Bitrix\ImBot\Sender\Csmbot();
