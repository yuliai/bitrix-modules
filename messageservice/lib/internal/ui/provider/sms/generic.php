	...
	public function createConnectionsSliderSections(array $senders): array
	{
		...
		foreach ($editorViewChannels as $editorViewChannel)
		{
			...
			$iconPath = $isConnected
				? '/bitrix/components/bitrix/messageservice.connections/images/generic-connected.svg'
				: '/bitrix/components/bitrix/messageservice.connections/images/generic-not-connected.svg';
