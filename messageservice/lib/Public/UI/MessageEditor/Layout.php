...
final class Layout implements \JsonSerializable
{
	...
	public function isMessageLengthCounterShown(): bool
	{
		return $this->isMessageLengthCounterShown;
	}

	public function setMessageLengthCounterShown(bool $isMessageLengthCounterShown): self
	{
		$this->isMessageLengthCounterShown = $isMessageLengthCounterShown;

		return $this;
	}

	public function isToSelectorShown(): bool
	{
		return $this->isToSelectorShown;
	}

	public function setToSelectorShown(bool $isToSelectorShown): self
	{
		$this->isToSelectorShown = $isToSelectorShown;

		return $this;
	}

	public function isChannelSelectorShown(): bool
	{
		return $this->isChannelSelectorShown;
	}

	public function setChannelSelectorShown(bool $isChannelSelectorShown): self
	{
		$this->isChannelSelectorShown = $isChannelSelectorShown;
