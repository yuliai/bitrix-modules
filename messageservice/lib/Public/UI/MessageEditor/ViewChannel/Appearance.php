...
final class Appearance implements \JsonSerializable
{
	public static function telegram(): self
	{
		return new self(
			Icon::telegram(),
			(string)Loc::getMessage('MESSAGESERVICE_UI_APPEARANCE_TELEGRAM'),
			(string)Loc::getMessage('MESSAGESERVICE_UI_APPEARANCE_TELEGRAM'),
		);
	}
	...
	public static function whatsapp(): self
	{
		return new self(
			Icon::whatsapp(),
			(string)Loc::getMessage('MESSAGESERVICE_UI_APPEARANCE_WHATSAPP'),
			(string)Loc::getMessage('MESSAGESERVICE_UI_APPEARANCE_WHATSAPP'),
		);
	}
	...
	public static function sms(): self
	{
		return new self(
			Icon::sms(),
			(string)Loc::getMessage('MESSAGESERVICE_UI_APPEARANCE_SMS'),
			(string)Loc::getMessage('MESSAGESERVICE_UI_APPEARANCE_SMS'),
		);
	}
