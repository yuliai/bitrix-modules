...
class ChildChatAttachedToProject implements MessageDataInterface
{
	...
	public function getText(): string
	{
		...
		{
			Gender::Female => 'SONET_V2_CHILD_CHAT_ATTACHED_TO_PROJECT_F',
			Gender::Male => 'SONET_V2_CHILD_CHAT_ATTACHED_TO_PROJECT_M',
			default => 'SONET_V2_CHILD_CHAT_ATTACHED_TO_PROJECT_N',
		};
