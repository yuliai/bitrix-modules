...
namespace Bitrix\Socialnetwork\V2\Internal\Integration\Im\EventHandler\OnAfterAttachChildEvent;
...
use Bitrix\Socialnetwork\V2\Internal\Integration\Im\Service\Message\ChildChatAttachedToProject;
use Bitrix\Socialnetwork\V2\Internal\Service\UserService;

class SendChildAttachedMessage
{
	public static function execute(AfterAttachChildEvent $event): void
	{
		$chat = $event->getChat();
		...
		$messageData = new ChildChatAttachedToProject($contextUser, (string)$workgroup->getName());
