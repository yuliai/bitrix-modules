...
class RemoveFromArchiveAction implements Action
{
	/**
	 * @param Closure(int): Result $unarchiveHandler fn(int $entityId): Result
	 */
	public function __construct(
		private readonly GridAccessServiceInterface $accessService,
		private readonly Closure $unarchiveHandler,
	...
	public function processRequest(HttpRequest $request, bool $isSelectedAllRows, ?Filter $filter): ?Result
	{
		...
		foreach ($ids as $id)
		{
			...
			$commandResult = ($this->unarchiveHandler)($entityId);
