...
namespace Bitrix\Socialnetwork\V2\Infrastructure\Grid\Workgroup\Row\Action;
...
class WorkgroupRowActionsProvider extends DataProvider
{
	...
	{
		parent::__construct();
		$this->accessService = Container::getInstance()->getLegacyGroupAccessService();
	}
