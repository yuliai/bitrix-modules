...
class ActionDictionary
{
	...
	public const ACTION_B2E_MY_SAFE_FIRED = 'ACTION_B2E_MY_SAFE_FIRED';

	public const ACTION_B2E_MY_SAFE_FOLDER_READ = 'ACTION_B2E_MY_SAFE_FOLDER_READ';
	public const ACTION_B2E_MY_SAFE_FOLDER_CREATE = 'ACTION_B2E_MY_SAFE_FOLDER_CREATE';
	public const ACTION_B2E_MY_SAFE_FOLDER_WRITE = 'ACTION_B2E_MY_SAFE_FOLDER_WRITE';
	public const ACTION_B2E_MY_SAFE_FOLDER_DELETE = 'ACTION_B2E_MY_SAFE_FOLDER_DELETE';
	...
	public const ACTION_B2E_SIGNERS_LIST_READ = 'ACTION_B2E_SIGNERS_LIST_READ';
	public const ACTION_B2E_SIGNERS_LIST_EDIT = 'ACTION_B2E_SIGNERS_LIST_EDIT';
	public const ACTION_B2E_SIGNERS_LIST_DELETE = 'ACTION_B2E_SIGNERS_LIST_DELETE';
	public const ACTION_B2E_SIGNERS_LIST_ADD = 'ACTION_B2E_SIGNERS_LIST_ADD';
	public const ACTION_B2E_SIGNERS_LIST_REFUSED_EDIT = 'ACTION_B2E_SIGNERS_LIST_REFUSED_EDIT';
	...
	public static function getActionPermissionMap(): array
	{
		return [
			...
			self::ACTION_B2E_MY_SAFE_FIRED => SignPermissionDictionary::SIGN_B2E_MY_SAFE_FIRED,

			self::ACTION_B2E_MY_SAFE_FOLDER_READ => SignPermissionDictionary::SIGN_B2E_MY_SAFE_FOLDER_READ,
			self::ACTION_B2E_MY_SAFE_FOLDER_CREATE => SignPermissionDictionary::SIGN_B2E_MY_SAFE_FOLDER_CREATE,
			self::ACTION_B2E_MY_SAFE_FOLDER_WRITE => SignPermissionDictionary::SIGN_B2E_MY_SAFE_FOLDER_WRITE,
			self::ACTION_B2E_MY_SAFE_FOLDER_DELETE => SignPermissionDictionary::SIGN_B2E_MY_SAFE_FOLDER_DELETE,
			...
			self::ACTION_B2E_SIGNERS_LIST_READ => SignPermissionDictionary::SIGN_B2E_SIGNERS_LIST_READ,
			self::ACTION_B2E_SIGNERS_LIST_ADD => SignPermissionDictionary::SIGN_B2E_SIGNERS_LIST_ADD,
			self::ACTION_B2E_SIGNERS_LIST_EDIT => SignPermissionDictionary::SIGN_B2E_SIGNERS_LIST_EDIT,
			self::ACTION_B2E_SIGNERS_LIST_DELETE => SignPermissionDictionary::SIGN_B2E_SIGNERS_LIST_DELETE,
			self::ACTION_B2E_SIGNERS_LIST_REFUSED_EDIT => SignPermissionDictionary::SIGN_B2E_SIGNERS_LIST_REFUSED,
		];
	}
