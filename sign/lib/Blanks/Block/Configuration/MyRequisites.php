...
class MyRequisites extends Configuration
{
	...
	public function validate(Item\Block $block): Main\Result
	{
		...
		if (!$block->data['hasFields'])
		{
			return $result->addError(
				new Main\Error(
					Loc::getMessage('SIGN_BLANKS_BLOCK_CONFIGURATION_MYREQUISITES_ERROR_EMPTY'),
	...
	public function loadData(Item\Block $block, Item\Document $document, ?Item\Member $member = null): array
	{
		...
		if ($member === null || $member->entityType !== EntityType::COMPANY)
		{
			return $result;
		}
