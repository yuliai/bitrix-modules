...
enum TemplateRegions: string
{
	...
	case BoardsUa = 'alaio.vibe_boards_ua';
	case BoardsSc = 'alaio.vibe_boards_sc';
	case BoardsTc = 'alaio.vibe_boards_tc';
	//Templates::Booking
	...
	case BookingUa = 'alaio.vibe_booking_ua';
	case BookingSc = 'alaio.vibe_booking_sc';
	case BookingTc = 'alaio.vibe_booking_tc';
