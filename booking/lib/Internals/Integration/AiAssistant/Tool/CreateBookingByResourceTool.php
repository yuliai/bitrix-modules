...
class CreateBookingByResourceTool extends BaseBookingTool
{
	...
	protected function doExecuteStructured(int $userId, ...$args): array
	{
		...
		return $this->createSuccessResponse(
			message: "Booking with identifier '{$booking->getId()}' has been successfully created",
	...
	{
		return 'create_booking_by_resource_tool';
	}

	public function getDescription(): string
	{
		return 'Creates a new booking with a specified resource. Use when the client has chosen a specific resource but has not specified services. The dateTime must correspond to an available slot previously retrieved via find_available_slots_by_resource_tool. The booking cannot be created in the past.';
	}
